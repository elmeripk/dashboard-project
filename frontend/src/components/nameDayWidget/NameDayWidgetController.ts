import { NameDayWidget } from "./NameDayWidget";
...
export class NameDayWidgetController {
     ...
     * @param view The NameDayWidget view instance to control
     */
    constructor(view: NameDayWidget) {
        this.view = view;
    ...
    /** 
     * Gets name days and updates the view
     * @postcondition Updates the view with fetched name days
     */
    private async updateNameDays(): Promise<void> {
        this.view.showLoading(true);
        const data = await this.getNameDays();
        this.view.renderNameDays(data);
